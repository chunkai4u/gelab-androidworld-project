...
printf '\nGELab-Zero × AndroidWorld\n\n1. Turn on Wi-Fi\n2. Create a note\n3. Create a note and share via SMS\n4. Record the emulator only (manual)\n\n'
read -r -p 'Choose 1–4: ' choice
case "$choice" in
  1) task=SystemWifiTurnOn; steps=15;;
  2) task=MarkorCreateNote; steps=25;;
  3) task=MarkorCreateNoteAndSms; steps=35;;
  4) exec "$PROJECT_DIR/Record-Screen.command";;
